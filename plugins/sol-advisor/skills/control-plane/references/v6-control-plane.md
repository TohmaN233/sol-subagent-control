# Legacy v6 execution only

Read this contract only when sol_control_status reports version6. For version7,
use the Workflow Run protocol in the skill entrypoint.
...
Read [references/architecture.md](architecture.md) for the trust boundary and
[references/provider-contracts.md](provider-contracts.md) before executing a
non-native provider.
